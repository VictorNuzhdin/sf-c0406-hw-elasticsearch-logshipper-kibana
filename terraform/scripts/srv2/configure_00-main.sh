...
#
#..configuring RSyslog Server for receive logs from remote Syslog Client
chmod +x $SCRIPTS_PATH/configure_07-logging-rsyslog-server.sh
sudo bash $SCRIPTS_PATH/configure_07-logging-rsyslog-server.sh
#
