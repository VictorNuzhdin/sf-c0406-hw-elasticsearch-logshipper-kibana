...
CONFIGS_PATH=/home/ubuntu/scripts/configs/step01_init
LOG_PATH=$SCRIPTS_PATH/configure_03-nginx.log
NEW_USER_LOGIN=devops
WEBSITE_DOMAIN_NAME=srv2.dotspace.ru
...
#host srv2.dotspace.ru >> $LOG_PATH
#curl -s http://srv2.dotspace.ru | grep title | awk '{$1=$1;print}' >> $LOG_PATH
#
